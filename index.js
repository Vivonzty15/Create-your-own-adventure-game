...
They are content with you staying, but you wonder if you should alert the world to this magical safe haven.`, `stay or spread the word`)
                if(thirdAnswer === 'stay'){
            ...
            let fourthAnswer = window.prompt(`You come across a chamber that reaches upward to a shining light above. 
...
and you comedically fall through each of the rungs below. Sheepish, you return home.`)
    ...
    let fifthAnswer = window.prompt(`You come across a snoring dragon. 
On the other side of him, you see a shiny chest of treasure. 
Another path would lead you away from the dragon altogether. Which path do you take?`,'shiny chest or away')

        if(fifthAnswer === 'shiny chest'){
            let sixthAnswer = window.prompt(`The dragon wakes up and sits upright. You only have a moment to respond, 
to stay or run`, `stay or run`)
                if(sixthAnswer === 'stay'){
            ...
            let seventhAnswer = window.prompt(`After walking a while longer, you come across a shiny blue flower. 
It is so beautiful that you decide you must either draw it or pick it. Which do you do?`,`draw it or pick it`)
